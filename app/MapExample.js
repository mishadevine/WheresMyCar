  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text onPress={() => this.setZoomLevelAnimated(mapRef, 17)}>
          Zoom in to zoom level 17
        </Text>
        <Text onPress={() => this.setZoomLevelAnimated(mapRef, 15)}>
          Zoom out to zoom level 15
        </Text>
        <Text onPress={() => this.setZoomLevelAnimated(mapRef, 15)}>
          Zoom out to zoom level 14
        </Text>
        ...
        <Text onPress={() => this.addAnnotations(mapRef, [{
          coordinates: [28.594442,-81.304008],
          type: 'point',
        ...
        <View style={styles.circle}>
          <Mapbox
            ...
            ref={mapRef}
            accessToken={'pk.eyJ1IjoibWRldmluZSIsImEiOiJjaW4wa2h2cnQwOXdidnFsdTQ0cTk1ZjlmIn0.ixV8rs0YeGS8DQpDrbEeIw'}
            styleURL={this.mapStyles.emerald}
